<template>
    <div class="flex ">
        <div class=" z-10 flex h-screen lg:w-16 md:w-0 flex-col justify-between border-r bg-white max-md:relative lg:">
            <div class="md:fixed md:bottom-0 md:left-0 lg:top-0 ">      
              <div class="border-t border-gray-100 md:z-10 md:bg-gray-200 lg:bg-white">
                <nav aria-label="Main Nav" class=" lg:flex lg:flex-col p-2 md:flex md:flex-row md:w-screen md:justify-center lg:justify-start lg:w-full">
                  <div class="py-4 md:py-6">
                    ...
                    <NuxtLink to="/finance/">     
                      ...
                      <span
                        class="absolute left-full top-1/2 ml-4 -translate-y-1/2 rounded bg-gray-900 px-2 py-1.5 text-xs font-medium text-white opacity-0 group-hover:opacity-100 md:hidden"
                      >
                        Dashboard
                      </span>
                    </a>
                  </div>
                  <ul class="space-y-1 border-t border-gray-100 pt-4 md:flex md:flex-row lg:flex-col">
                        
                    <li>
                      <a
                        href=""
                        class="group relative flex justify-center rounded px-2 py-2.5 text-gray-500 hover:bg-gray-50 hover:text-gray-700"
                      >
                    <NuxtLink to="/finance/localFinance">  
                    ...
                    <li>
                      ...
                      >
                      <NuxtLink to="/finance/sectionFinance"> 
                    ...
                    <li>
                      <a
                        ...
                        class="group relative flex justify-center rounded px-2 py-1.5 text-gray-500 hover:bg-gray-50 hover:text-gray-700"
                      >
                      <NuxtLink to="/finance/organisationFinance/"> 
            ...
            <div class="sticky inset-x-0 bottom-0 border-t border-gray-100 bg-white p-2 md:hidden lg:visible">
                <NuxtLink class="group relative flex w-full justify-center rounded-lg px-2 py-1.5 text-sm text-gray-500 hover:bg-gray-50 hover:text-gray-700" to="/">
