  ...
  <div class="flex">
      <div class=" z-10 flex h-screen lg:w-16 md: w-0 flex-col justify-between border-r bg-white max-md:relative lg:">
                ...
                <ul class="space-y-1 border-t border-gray-100 pt-4 md:flex md:flex-row lg:flex-col">
                  ...
                  <li>
                    <a
                      ...
                      class="group relative flex justify-center rounded px-2 py-1.5 text-gray-500 hover:bg-gray-50 hover:text-gray-700"
                    >
                    <NuxtLink to="/admin/financesAccounts"> 
                      <svg width="24" height="24" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/> <path d="M4.271 18.3457C4.271 18.3457 6.50002 15.5 12 15.5C17.5 15.5 19.7291 18.3457 19.7291 18.3457" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/> <path d="M12 12C13.6569 12 15 10.6569 15 9C15 7.34315 13.6569 6 12 6C10.3431 6 9 7.34315 9 9C9 10.6569 10.3431 12 12 12Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/> </svg>
                    </NuxtLink>
                      <span
                        class="absolute left-full top-1/2 ml-4 -translate-y-1/2 rounded bg-gray-900 px-2 py-1.5 text-xs font-medium text-white opacity-0 group-hover:opacity-100 md:invisible lg:visible"
          ...
          <div class="sticky inset-x-0 bottom-0 border-t border-gray-100 bg-white p-2 md:hidden lg:visible">
              <NuxtLink to="../auth/login" class="group relative flex w-full justify-center rounded-lg px-2 py-1.5 text-sm text-gray-500 hover:bg-gray-50 hover:text-gray-700">
